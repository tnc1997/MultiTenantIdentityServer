...
public partial class InitialIdentityServerConfigurationDbMigration : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => { table.PrimaryKey("PK_Clients", x => new { x.Id, x.TenantId }); });
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => { table.PrimaryKey("PK_IdentityProviders", x => new { x.Id, x.TenantId }); });
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_ClientClaims", x => new { x.Id, x.TenantId });
                table.ForeignKey(
                    "FK_ClientClaims_Clients_ClientId_TenantId",
                    x => new { x.ClientId, x.TenantId },
                    "Clients",
                    new[] { "Id", "TenantId" },
                    onDelete: ReferentialAction.Cascade);
            });
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_ClientCorsOrigins", x => new { x.Id, x.TenantId });
                table.ForeignKey(
                    "FK_ClientCorsOrigins_Clients_ClientId_TenantId",
                    x => new { x.ClientId, x.TenantId },
                    "Clients",
                    new[] { "Id", "TenantId" },
                    onDelete: ReferentialAction.Cascade);
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_ClientGrantTypes", x => new { x.Id, x.TenantId });
                table.ForeignKey(
                    "FK_ClientGrantTypes_Clients_ClientId_TenantId",
                    x => new { x.ClientId, x.TenantId },
                    "Clients",
                    new[] { "Id", "TenantId" },
                    onDelete: ReferentialAction.Cascade);
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_ClientIdPRestrictions", x => new { x.Id, x.TenantId });
                table.ForeignKey(
                    "FK_ClientIdPRestrictions_Clients_ClientId_TenantId",
                    x => new { x.ClientId, x.TenantId },
                    "Clients",
                    new[] { "Id", "TenantId" },
                    onDelete: ReferentialAction.Cascade);
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_ClientPostLogoutRedirectUris", x => new { x.Id, x.TenantId });
                table.ForeignKey(
                    "FK_ClientPostLogoutRedirectUris_Clients_ClientId_TenantId",
                    x => new { x.ClientId, x.TenantId },
                    "Clients",
                    new[] { "Id", "TenantId" },
                    onDelete: ReferentialAction.Cascade);
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_ClientProperties", x => new { x.Id, x.TenantId });
                table.ForeignKey(
                    "FK_ClientProperties_Clients_ClientId_TenantId",
                    x => new { x.ClientId, x.TenantId },
                    "Clients",
                    new[] { "Id", "TenantId" },
                    onDelete: ReferentialAction.Cascade);
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_ClientRedirectUris", x => new { x.Id, x.TenantId });
                table.ForeignKey(
                    "FK_ClientRedirectUris_Clients_ClientId_TenantId",
                    x => new { x.ClientId, x.TenantId },
                    "Clients",
                    new[] { "Id", "TenantId" },
                    onDelete: ReferentialAction.Cascade);
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_ClientScopes", x => new { x.Id, x.TenantId });
                table.ForeignKey(
                    "FK_ClientScopes_Clients_ClientId_TenantId",
                    x => new { x.ClientId, x.TenantId },
                    "Clients",
                    new[] { "Id", "TenantId" },
                    onDelete: ReferentialAction.Cascade);
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_ClientSecrets", x => new { x.Id, x.TenantId });
                table.ForeignKey(
                    "FK_ClientSecrets_Clients_ClientId_TenantId",
                    x => new { x.ClientId, x.TenantId },
                    "Clients",
                    new[] { "Id", "TenantId" },
                    onDelete: ReferentialAction.Cascade);
        ...
        migrationBuilder.CreateIndex(
            "IX_ClientClaims_ClientId_TenantId",
            "ClientClaims",
        ...
        migrationBuilder.CreateIndex(
            ...
            "ClientClaims",
            new[] { "ClientId", "Type", "Value", "TenantId" },
            unique: true);

        migrationBuilder.CreateIndex(
            "IX_ClientCorsOrigins_ClientId_Origin",
            "ClientCorsOrigins",
            new[] { "ClientId", "Origin", "TenantId" },
            unique: true);

        migrationBuilder.CreateIndex(
            "IX_ClientCorsOrigins_ClientId_TenantId",
            "ClientCorsOrigins",
            new[] { "ClientId", "TenantId" });
        ...
        migrationBuilder.CreateIndex(
            ...
            "ClientGrantTypes",
            new[] { "ClientId", "GrantType", "TenantId" },
            unique: true);

        migrationBuilder.CreateIndex(
            "IX_ClientGrantTypes_ClientId_TenantId",
            "ClientGrantTypes",
            new[] { "ClientId", "TenantId" });
        ...
        migrationBuilder.CreateIndex(
            ...
            "ClientIdPRestrictions",
            new[] { "ClientId", "Provider", "TenantId" },
            unique: true);

        migrationBuilder.CreateIndex(
            "IX_ClientIdPRestrictions_ClientId_TenantId",
            "ClientIdPRestrictions",
            new[] { "ClientId", "TenantId" });
        ...
        migrationBuilder.CreateIndex(
            ...
            "ClientPostLogoutRedirectUris",
            new[] { "ClientId", "PostLogoutRedirectUri", "TenantId" },
            unique: true);

        migrationBuilder.CreateIndex(
            "IX_ClientPostLogoutRedirectUris_ClientId_TenantId",
            "ClientPostLogoutRedirectUris",
            new[] { "ClientId", "TenantId" });
        ...
        migrationBuilder.CreateIndex(
            ...
            "ClientProperties",
            new[] { "ClientId", "Key", "TenantId" },
            unique: true);

        migrationBuilder.CreateIndex(
            "IX_ClientProperties_ClientId_TenantId",
            "ClientProperties",
            new[] { "ClientId", "TenantId" });
        ...
        migrationBuilder.CreateIndex(
            ...
            "ClientRedirectUris",
            new[] { "ClientId", "RedirectUri", "TenantId" },
            unique: true);

        migrationBuilder.CreateIndex(
            "IX_ClientRedirectUris_ClientId_TenantId",
            "ClientRedirectUris",
            new[] { "ClientId", "TenantId" });
        ...
        migrationBuilder.CreateIndex(
            ...
            "ClientScopes",
            new[] { "ClientId", "Scope", "TenantId" },
            unique: true);

        migrationBuilder.CreateIndex(
            "IX_ClientScopes_ClientId_TenantId",
            "ClientScopes",
            new[] { "ClientId", "TenantId" });

        migrationBuilder.CreateIndex(
            "IX_ClientSecrets_ClientId_TenantId",
            "ClientSecrets",
            new[] { "ClientId", "TenantId" });
